...
// applies.
// argumentIsNativeNumber reports whether the first argument reaches SQLite
// as an INTEGER or REAL rather than an encoded value, so SQLite's own
// ordering applies to it.
